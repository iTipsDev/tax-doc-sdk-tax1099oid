...
import irs.fdxtax641.jsonserializers.Tax1099OidSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099Oid;
import org.taxdataexchange.core.pdfbuilders.Tax1099OidPdfBuilder;
...
public class Tax1099OidDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099Oid obj = Map2Tax1099Oid.generate( row );
        {
            String asJson = Tax1099OidSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099Oid.csv";
        ...
        String outputFileName = "Tax1099Oid.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099OidDocumentGenerator generator = new Tax1099OidDocumentGenerator( );
